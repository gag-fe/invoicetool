...
const ChangeInfo = React.createClass({
	...
	_handleTextValue(idx, event){
		...
		let items = this.props.getStoreState().changeConfigData
		temp["comment"] = text;
							...
							<Case value={"ADD"}>
								<div>
									...
									<FormItem
										...
										wrapperCol={{ span: 14 }}
									>
										<Input type="textarea" value={item.newConfig} name="newConfig" disabled={true}/>
									</FormItem>
									<FormItem
										label="变更描述:"
										labelCol={{ span: 4 }}
							...
							<Case value={"UPDATE"}>
								<div>
									...
									<FormItem
										...
										wrapperCol={{ span: 14 }}
									>
										<Input type="textarea" value={item.oldConfig} name="oldConfig" disabled={true}/>
									</FormItem>
									<FormItem
										label="变更描述:"
										labelCol={{ span: 4 }}
