...
const FormAction = React.createClass({
	...
	_handleOk() {
		...
		let strategyList = this.props.getStoreState().strategyList;
	...
	_getRadioTemplateValue(value){
		let temp = {};
		let strategyLists = this.props.getStoreState().strategyTemplate;
		let item = this.props.getStoreState().editorData;
