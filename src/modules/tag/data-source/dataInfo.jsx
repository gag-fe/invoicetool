...
let returnDataMapping = [];

let tempParameterMapping = {
	key: "",
	value: "",
	dataType: "STRING"
};
let tempReturnDataMapping = {
	key: "",
	value: "",
	dataType: "STRING"
};
...
const DataInfo = React.createClass({
	...
	_onChangeField(key, sale, type, idx, event){
		...
		let sourceMeta = this.state.sourceMeta;
		let parameterMapping = [];
		let returnDataMapping = [];
		let items = {};
	...
	_handleSelectChange(key, sale, idx, value){
		let item = this.state.sourceMeta;
										...
										<Form horizontal className="ant-advanced-search-form">
											...
											<Row gutter={16}>
												<Col span={12} offset={12} style={{ textAlign: 'right' }}>
													<Button type="primary"
													        onClick={this._configureAddItemHsfParam.bind(this,"HSF")}>添加参数字段映射</Button>
												</Col>
											</Row>
										</Form>
									</Col>
									...
									<Col>
										<Form horizontal className="ant-advanced-search-form">
											...
											<Row gutter={16}>
												<Col span={12} offset={12} style={{ textAlign: 'right' }}>
													<Button type="primary"
													        onClick={this._configureAddItemHsfReturn.bind(this,"HSF")}>添加参数字段映射</Button>
												</Col>
											</Row>
										</Form>
									...
									<Col>
										<Form horizontal className="ant-advanced-search-form">
											...
											<Row gutter={16}>
												<Col span={12} offset={12} style={{ textAlign: 'right' }}>
													<Button type="primary"
													        onClick={this._configureAddItemHttpParam.bind(this,"HTTP")}>添加参数字段映射</Button>
												</Col>
											</Row>
										</Form>
									</Col>
									...
									<Col>
										<Form horizontal className="ant-advanced-search-form">
											...
											<Row gutter={16}>
												<Col span={12} offset={12} style={{ textAlign: 'right' }}>
													<Button type="primary"
													        onClick={this._configureAddItemHttpReturn.bind(this,"HTTP")}>添加参数字段映射</Button>
