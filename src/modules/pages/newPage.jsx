...
class NewPage extends React.Component {
    ...
    return (
      <div>
          <Row type="flex" justify="center" align="middle" className="margin-bottom-20">
            <Col span={4}><label for="page-name" className="ant-form-item-required-fix">页面名称: </label></Col>
          ...
          <Row type="flex" justify="center" align="middle" className="margin-bottom-20">
            <Col span={4}><label for="url-name" className="ant-form-item-required-fix">URL: </label></Col>
          ...
          <Row type="flex" justify="center" align="middle" className="margin-bottom-20">
            <Col span={4}><label for="page-modules">页面内模块: </label></Col>
  ...
  submit() {
    ...
    Promise.all([NewPageService.validatePageName(pageName),NewPageService.validatePageUrl(url)]).then(results => {
      let pageNameResult = results[0];
      let pageUrlResult = results[1];
      let pageNameResultData = pageNameResult.data;
      let pageUrlResultData = pageUrlResult.data;
